...
- Check the Ruby version or if you have at all by running `ruby -v` if it returns  `ruby 3.0.5p20 (2022-04-12 revision 4491bb740a)` or similar, you have Ruby installed.

* Ruby version used `ruby 3.0.5`
...
- Clone the repository using the GitHub this link [🔗](https://github.com/ademibowale/hello-rails_react.git)
